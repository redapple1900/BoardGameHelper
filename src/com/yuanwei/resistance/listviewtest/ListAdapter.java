...
public class ListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.description.setText(context.getString(R.string.listitem_descr1)
				+ player.getWin() + context.getString(R.string.listitem_descr2)
				+ (player.getWin() + player.getLose())
				+ context.getString(R.string.listitem_descr3));
